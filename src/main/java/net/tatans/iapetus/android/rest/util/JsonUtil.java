...
public class JsonUtil {
	...
	// Java object -> json string
	public static String arr2JsonStr(Object obj) {
	...
	public static Object json2Obj(JSONObject json) {
	...
	public static Map<String, String> jsonstr2Map(String jsonString) {
		...
		for (Object k : json.keySet()) {
			map.put((String) k, (String) json.get(k));
		}
		return map;
	}
	public static String obj2JsonStr(Object obj, JsonConfig config) {
