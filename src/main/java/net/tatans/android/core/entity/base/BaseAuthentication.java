package net.tatans.android.core.entity.base;
...
public abstract class BaseAuthentication  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof net.tatans.android.core.entity.Authentication)) return false;
		else {
			net.tatans.android.core.entity.Authentication authentication = (net.tatans.android.core.entity.Authentication) obj;
