...
public abstract class BaseUnifiedUser  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof net.tatans.android.core.entity.UnifiedUser)) return false;
		else {
			net.tatans.android.core.entity.UnifiedUser unifiedUser = (net.tatans.android.core.entity.UnifiedUser) obj;
