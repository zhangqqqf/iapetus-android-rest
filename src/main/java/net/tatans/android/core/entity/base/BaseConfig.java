...
public abstract class BaseConfig  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof net.tatans.android.core.entity.Config)) return false;
		else {
			net.tatans.android.core.entity.Config config = (net.tatans.android.core.entity.Config) obj;
