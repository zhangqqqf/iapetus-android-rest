package net.tatans.android.common.security.rememberme;
...
import net.tatans.android.common.security.UsernameNotFoundException;
import net.tatans.android.common.security.userdetails.AccountStatusUserDetailsChecker;
import net.tatans.android.common.security.userdetails.UserDetails;
import net.tatans.android.common.security.userdetails.UserDetailsChecker;
import net.tatans.android.common.security.userdetails.UserDetailsService;
...
public abstract class AbstractRememberMeServices implements RememberMeService,
	 ...
	 *            include additional base indicating that a persistent
	 *            login is desired.
	 * @param parameter
	 *            the configured remember-me parameter name.
	 * 
	 * @return true if the request includes base indicating that a
