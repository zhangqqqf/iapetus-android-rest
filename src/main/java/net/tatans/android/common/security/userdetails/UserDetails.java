...
/**
 * Provides core user base.
 * 
 * <p>
 * Implementations are not used directly by Spring Security for security
 * purposes. They simply store user base which is later encapsulated into
 * {@link Authentication} objects. This allows non-security related user
 * base (such as email addresses, telephone numbers etc) to be stored in
 ...
 * {@link org.springframework.GameUser.core.userdetails.User} for a reference
