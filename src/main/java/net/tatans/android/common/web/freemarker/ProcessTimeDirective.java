package net.tatans.android.common.web.freemarker;

import static net.tatans.android.common.web.ProcessTimeFilter.START_TIME;
 ...
 * 执行时间标签
 * 
 * 需要拦截器net.tatans.androidversion.common.web.ProcessTimeFilter支持
 */
