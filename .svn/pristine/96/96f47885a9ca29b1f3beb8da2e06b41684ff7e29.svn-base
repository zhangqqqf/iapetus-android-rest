...
public abstract class BaseDbTpl  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof net.tatans.android.core.entity.DbTpl)) return false;
		else {
			net.tatans.android.core.entity.DbTpl dbTpl = (net.tatans.android.core.entity.DbTpl) obj;
