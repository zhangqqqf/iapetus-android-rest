...
public abstract class BaseDbFile  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof net.tatans.android.core.entity.DbFile)) return false;
		else {
			net.tatans.android.core.entity.DbFile dbFile = (net.tatans.android.core.entity.DbFile) obj;
