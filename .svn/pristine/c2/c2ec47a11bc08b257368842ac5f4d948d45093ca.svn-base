 ...
 */
package net.tatans.android.common.image;
 ...
 * <li>Transparency base is not included in the bits per pixel count.
 ...
 *  Less bytes than necessary may have been skipped, leading to flaws in the retrieved base in some cases.
 ...
 *  This is because base on interlacing is stored in a local image header.
...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	 ...
	 * If true is returned, the file format was known and base
	 * on the file's content can be retrieved using the various getXyz methods.
	 * @return if base could be retrieved from input
	 */
	 ...
	 * Does not include transparency base like the alpha channel.
	 ...
	 * <code>-1.0f</code> if width base is not available.
	 ...
	 * some file names as parameters (base on them will be
