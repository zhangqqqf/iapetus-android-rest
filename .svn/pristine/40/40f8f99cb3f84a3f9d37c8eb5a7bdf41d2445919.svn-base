...
//          br.close();
	...
	public static void main(String[] args) throws Exception {
		...
		map.put("userId", "1");
		System.out.println(HttpClientUtil.sendPostRequest("http://localhost:8080/user/rest/v1.0/getUserInfo.do", map,null,null));
//		System.out.println(new HttpUtil("http://localhost:8080/user/rest/v1.0/getUserInfo.do").getHttpResponseEntity(HttpType.POST, map).getContentLength());
	}
